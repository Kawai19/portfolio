document.addEventListener('DOMContentLoaded', function () {
  ...
  // Плавное затемнение хедера при скролле
  ...
  function updateHeaderOpacity() {
    ...
    header.style.background = `linear-gradient(rgba(0,0,0,${opacity}), rgba(0,0,0,${opacity})), url("res/pstars.jpg") center/cover no-repeat`;
    if (progress > 0.05) {
